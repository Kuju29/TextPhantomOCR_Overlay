...
const USER_MESSAGES = Object.freeze({
  ...
  LOCAL_ENDPOINT_UNSAFE: "URL ของ Local AI ต้องเป็นเครื่องนี้หรือเครือข่ายส่วนตัว",
  LOCAL_UNREACHABLE: "เชื่อมต่อ Local AI ไม่ได้—ตรวจว่าเปิดโปรแกรม, URL และ CORS แล้ว",
...
export function userMessageForCode(code) {
  ...
  const aliases = {
    ...
    invalid_local_endpoint: "LOCAL_ENDPOINT_UNSAFE", local_endpoint_not_private: "LOCAL_ENDPOINT_UNSAFE",
    local_ai_unreachable: "LOCAL_UNREACHABLE", local_connection_failed: "LOCAL_UNREACHABLE",
    local_cors_blocked: "LOCAL_UNREACHABLE", local_ai_timeout: "LOCAL_TIMEOUT",
    local_timeout: "LOCAL_TIMEOUT", local_model_missing: "LOCAL_MODEL_MISSING",
    local_model_not_found: "LOCAL_MODEL_UNAVAILABLE",
    local_ai_endpoint_incompatible: "LOCAL_INCOMPATIBLE", local_ai_http_error: "LOCAL_INCOMPATIBLE",
