...
*Note: เวอร์ชั่น 4.0.0 ยังไม่ได้ทดสอบทั้งหมดนะครับ ถ้าเจอบัคก็แจ้งใน youtube หรือใน github ก็ได้ครับ* 
