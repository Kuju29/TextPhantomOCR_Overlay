...
LANG_STYLE: Final[dict[str, str]] = {
    ...
    "th": (
        ...
        "GENDER SAFETY: Because you usually cannot see who speaks, do not guess gender. Default to Thai subject-drop. "
        "Avoid gendered or relationship-heavy words such as ผม / ฉัน / หนู / นาย / เธอ / คุณ / ครับ / ค่ะ / คะ "
        "unless the source, name, title, or context clearly requires them. If a subject is needed, prefer neutral phrasing, "
        "the character name, role/title, เรา, ตัวเอง, or fantasy/noble ข้า / เจ้า / ท่าน.\n"
        "PARTICLES / TONE: Carry emotion with mostly gender-neutral endings: นะ, สิ, ล่ะ, เถอะ, เลย, แล้ว, เหรอ, รึเปล่า, "
        "เนี่ย, นั่นแหละ. Use ครับ / ค่ะ / คะ only when the speaker's polite gendered voice is clear.\n"
        ...
        "Thai transliteration. Common fantasy/game terms may stay fun and familiar: มอนสเตอร์, ดันเจี้ยน, สกิล, ไอเทม, "
        "บอส, เวท, เลเวล. Examples: Gaia=ไกอา, Cardinal=คาร์ดินัล, Mithril=มิธริล.\n"
        ...
        "  - ภรรยาฉันอึดอัด ช่วยเข้าใจกันหน่อย\n"
        "  - ข้าเองก็คาดหวังในตัวเจ้าอยู่นะ\n"
        "Mini conversion examples:\n"
