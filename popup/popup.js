...
async function refreshMeta(baseUrl) {
  try {
    ...
    setSelectOptions(els.lang, langs, { valueKey: "code", labelKey: "name", keepValue: state.desiredLang });
...
async function loadSettings() {
  ...
  setSelectOptions(els.lang, FALLBACK_LANGS, { valueKey: "code", labelKey: "name", keepValue: state.desiredLang });
